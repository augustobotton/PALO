...
class ModeloAtmosferico:
	...
	def calcula(self, altitude_geometrica, v, lc, dT):
		...
		return {
			'temperatura_cinetica': temperatura_cinetica,
			'temperatura_escala_molecular': temperatura_escala_molecular,
			'pressao': pressao,
			'densidade_do_ar': densidade_do_ar,
			'velocidade_do_som': velocidade_do_som,
			'numero_de_mach': numero_de_mach,
			'viscosidade_dinamica': viscosidade_dinamica,
			'numero_de_prandtl': numero_de_prandtl,
			'numero_de_knudsen': numero_de_knudsen,
			'parametro_regime_de_escoamento': parametro_regime_de_escoamento,
			'reynolds': reynolds,
			'constante_de_gas_ideal': constante_de_gas_ideal
		}
