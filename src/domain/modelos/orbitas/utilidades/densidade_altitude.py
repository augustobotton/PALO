...
def densidade_altitude(z):
    """
    Calcula a densidade do ar em função da altitude, usando o modelo atmosférico USSA76.
    A densidade é dada em kg/m^3.
    ...
    r = np.array([1.225,
                  4.008e-2, 1.841e-2, 3.996e-3, 1.027e-3, 3.097e-4, 8.283e-5,
