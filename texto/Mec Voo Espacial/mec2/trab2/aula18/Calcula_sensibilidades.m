function Calcula_sensibilidades
% Exemplo 8.4 do livro
...
% Sao realizados os calculos de derivadas pelos metodos numerico e
% analitico, para conferir os resultados
%% Dados
