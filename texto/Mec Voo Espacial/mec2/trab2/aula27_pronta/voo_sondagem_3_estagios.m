...
T=3000; %input('Informe o tempo da simulacao (s): ');
V0=5;%input('Informe o valor inicial da velocidade relativa (m/s): ');
A0=89.99;%input('Informe o azimute inicial da velocidade relativa (graus): ');
A0=A0*pi/180;  % Azimute da velocidade relativa em t=0
phi0=70;%input('Informe a elevacao inicial da velocidade relativa (graus): ');
