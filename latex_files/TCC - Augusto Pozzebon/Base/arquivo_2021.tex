...
\author{Augusto Botton Pozzebon}   %%%%% AUTOR DO TRABALHO
...
\email{augusto.pozzebon@acad.ufsm.br}   %%%% E-MAIL PARA CATALOGRAFICA (COPYRIGHT) - OBRIGATORIO
...
\orientador{André Luis da Silva}{Dr}{UFSM}{M}{P}  %%%INFORMACOES SOBRE ORIENTADOR: OS CAMPOS SAO:{NOME}{SIGLA DA TITULACAO}{SIGLA DA INSTITUICAO DE ORIGEM}{SEXO} M=masculino   F=feminino {PARTE DA BANCA?} P=presidente  M=Membro  N=Nao faz parte
...
% % % DATA DA DEFESA 
\data{01}{07}{2023} %% FORMATO {DD}{MM}{AAAA}
...
%%%%%%%% OBS: A MDT possibilita a desmembração em duas listas separadas, mas isso não é possível neste template
...
\begin{document}
	...
	\input{Geral/Texto/1-Introdução}
        \input{Geral/Texto/tutorial}   
	\input{Geral/Texto/Conclusão}
